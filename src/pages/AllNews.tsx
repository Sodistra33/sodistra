      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 animate-slide-up">
            ...
            <span className="text-accent font-semibold text-sm uppercase tracking-wider">NOS ACTIONS RSE
          </span>
          ...
          {loading ? <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            </div> : dbArticles.length === 0 ? <div className="text-center py-20">
              ...
              {dbArticles.map((article: any, index: number) => <Card key={article.id} className="overflow-hidden group hover:shadow-xl transition-all duration-300 animate-slide-up" style={{
